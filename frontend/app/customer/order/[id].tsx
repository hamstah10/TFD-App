      ...
      >
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Ionicons name="car-sport" size={20} color="#bd1f22" />
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Ionicons name="speedometer" size={20} color="#bd1f22" />
            <Text style={styles.sectionTitle}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Ionicons name="document" size={20} color="#bd1f22" />
            <Text style={styles.sectionTitle}>
          ...
          <View style={styles.card}>
            <View style={styles.fileInfo}>
              <Ionicons name="document-attach" size={32} color="#bd1f22" />
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Ionicons name="information-circle" size={20} color="#bd1f22" />
            <Text style={styles.sectionTitle}>
